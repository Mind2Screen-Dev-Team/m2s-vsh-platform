...
| Project | Jenis | URL/Link Repository | Deskripsi |
|---|---|---|---|
| MetaGPT | Multi-agent framework | https://github.com/FoundationAgents/MetaGPT | "Perusahaan AI pertama" — tim agen berperan (PM/arsitek/engineer) berbasis SOP. Simulasi alur kerja internal, bukan repo GitHub nyata + penegakan aturan |
...
| Orca (stablyai) | Orkestrasi | https://github.com/stablyai/orca | Lingkungan pengembangan untuk kawanan agen paralel. Konsep paralel mirip, tapi IDE |

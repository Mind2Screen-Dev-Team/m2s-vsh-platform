...
description: Menjaga dokumentasi pengguna, operator, developer, dan rilis tetap konsisten dengan implementasi yang telah disetujui.
model: sonnet
effort: low
...
dengan implementasi yang telah disetujui.
